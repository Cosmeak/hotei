...
<template>
  <form
    ...
    class="container max-w-4xl my-24"
  >
    <Card class="bg-white">
      <CardContent class="flex flex-col gap-4">
        ...
        <div class="flex w-full gap-4">
          ...
          <div class="flex-1">
            ...
            <Select class="w-full" v-model="form.craftsmanship">
              <SelectTrigger>
                <SelectValue class="w-full" placeholder="Select a category" />
              </SelectTrigger>
              <SelectContent>
                <SelectGroup>
                  <SelectItem
        ...
        <div class="w-full">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex gap-4 w-full">
              ...
              <Button  class="flex-1" @click.prevent="addMaterial">
                <Plus />
              </Button>
            </div>
          </div>
